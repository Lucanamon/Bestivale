...
namespace Bestivale.Infrastructure.Migrations
{
    ...
    [Migration("20260326105629_AddInventoryItemLinkToMarketListings")]
    partial class AddInventoryItemLinkToMarketListings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bestivale.Domain.Entities.InventoryEgg", b =>
                {
                    ...
                    b.ToTable("InventoryEggs");
                });

            modelBuilder.Entity("Bestivale.Domain.Entities.InventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerUserId", "IsFavorite");

                    b.HasIndex("OwnerUserId", "ItemType");

                    b.ToTable("InventoryItems");
                });

            modelBuilder.Entity("Bestivale.Domain.Entities.InventoryMonster", b =>
                {
                    b.Property<Guid>("InventoryItemId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Bestivale.Domain.Entities.InventoryEgg", b =>
                {
                    b.HasOne("Bestivale.Domain.Entities.InventoryItem", "InventoryItem")
                        .WithOne("InventoryEgg")
                        .HasForeignKey("Bestivale.Domain.Entities.InventoryEgg", "InventoryItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Bestivale.Domain.Entities.InventoryMonster", b =>
                {
                    b.HasOne("Bestivale.Domain.Entities.InventoryItem", "InventoryItem")
                        .WithOne("InventoryMonster")
                        .HasForeignKey("Bestivale.Domain.Entities.InventoryMonster", "InventoryItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Bestivale.Domain.Entities.MarketListing", b =>
                {
                    b.HasOne("Bestivale.Domain.Entities.Egg", "Egg")
                        .WithMany()
                        .HasForeignKey("EggId")
            ...
            modelBuilder.Entity("Bestivale.Domain.Entities.InventoryItem", b =>
                {
                    b.Navigation("InventoryEgg");

                    b.Navigation("InventoryMonster");
                });
