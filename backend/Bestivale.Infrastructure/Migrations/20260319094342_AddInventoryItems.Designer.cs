...
namespace Bestivale.Infrastructure.Migrations
{
    ...
    [Migration("20260319094342_AddInventoryItems")]
            ...
            modelBuilder.Entity("Bestivale.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 19, 9, 43, 42, 194, DateTimeKind.Utc).AddTicks(7391),
                            CurrencyBalance = 9999,
                            IsRootAdmin = true,
                            PasswordHash = "$2a$11$fh8CNisPuswzmFV3bkjDIeAq49nu9DFLvkh18a53sNM4BEeTp1wMG",
                            Role = "RootAdmin",
                            Username = "rootadmin"
                        });
                });
