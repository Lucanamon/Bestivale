...
namespace Bestivale.Infrastructure.Migrations
{
    ...
    [Migration("20260326085846_AddFavoriteColumns")]
    partial class AddFavoriteColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bestivale.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 26, 8, 58, 45, 419, DateTimeKind.Utc).AddTicks(5428),
                            CurrencyBalance = 9999,
                            IsRootAdmin = true,
                            PasswordHash = "$2a$11$/D4IU7FIRskKrJVXUlqVROCJqc6jePQIBuPHz6j0COH2PYCyiKowq",
                            Role = "RootAdmin",
                            Username = "rootadmin"
                        });
                });
